...
- The pathway is split between an upward moving lane and a
downward moving lane
- This high flow of traffic interrupts the main points of intersection
- Semicircles have been placed throughout the space to encourage human
to human interaction
- The semicircles are not used regularly for socializing purposes
- Semicircles may enforce the idea that the main pathway is busy and
needs to be traversed quickly
